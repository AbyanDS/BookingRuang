...
<head>
    ...
    <title>Dashboard Admin - Booking Ruangan</title>
...
<body>
    ...
    <div class="container dashboard-container">
        <div class="alert alert-info">
            <strong>ℹ️ Informasi:</strong> Sebagai Admin, Anda bertanggung jawab untuk mengelola ruangan, booking, jadwal, user, laporan, dan approval peminjaman ruangan. Anda tidak dapat melakukan booking ruangan.
        </div>
        
        <!-- Statistics Dashboard -->
        <div class="stats-dashboard-admin">
            <a href="ruangan.php" class="stat-card-admin stat-total">
            ...
            <a href="booking.php" class="stat-card-admin stat-booking">
                <div class="stat-icon-admin">
            ...
            <a href="booking.php?status=pending" class="stat-card-admin stat-pending">
                <div class="stat-icon-admin">
            ...
            <a href="booking.php" class="stat-card-admin stat-today">
                <div class="stat-icon-admin">
            ...
            <a href="booking.php?status=approved" class="stat-card-admin stat-approved">
                <div class="stat-icon-admin">
            ...
            <a href="users.php" class="stat-card-admin stat-users">
                <div class="stat-icon-admin">
        ...
        <div class="alert alert-warning">
            ...
            <a href="booking.php?status=pending" style="color: #856404; text-decoration: underline;">Lihat sekarang</a>
        </div>
        <?php endif; ?>
    </div>
